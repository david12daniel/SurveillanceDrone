...
| **Thermal camera** | **PurpleRiver Mini 640** (640×512, 12 µm, 13 mm lens, USB) | [`T13`](https://www.thermal-image.com/product/mini-640-uncooled-lwir-thermal-camera-module/) | earlier | `FIXED_THERMAL_ID = "T13"` | meets Johnson detect/recognize at 90–120 m; USB output. | **2** |
